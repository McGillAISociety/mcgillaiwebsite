          ...
          <Navbar.Collapse className = "navbar-collapse" id="basic-navbar-nav">
            <Nav onSelect={this.clickedNav} className = "mr-auto">
              ...
              <NavDropdown
                ...
                <NavDropdown.Item target="_blank" href="https://medium.com/mcgill-artificial-intelligence-review" rel="noopener" className="navLink"><Navbar.Text className='external-text'><i className="fa fa-medium fa-fw"></i>  Blog</Navbar.Text></NavDropdown.Item>
              </NavDropdown>
              ...
              <NavDropdown
                ...
                <NavDropdown.Item target="_blank" href= "http://maishacks.com/" rel="noopener" className="navLink"><Navbar.Text className='droptext'><i className="fa fa-lightbulb-o fa-fw"></i>  MAIS Hacks</Navbar.Text></NavDropdown.Item>
                <NavDropdown.Item target="_blank" href= "http://mcgillailearn.com/" rel="noopener" className="navLink"><Navbar.Text className='droptext'><i className="fa fa-cogs fa-fw"></i>  Learnathon Conference</Navbar.Text></NavDropdown.Item>
