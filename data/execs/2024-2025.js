const path = (name) => `/images/team/2024-2025/${name}.png`;
...
export default [
    ...
    },
    {
        ...
        name: 'Alexandre Lamarche',
        position: 'Podcast Producer',
        bio: "Alexandre is a second year Software Engineering student with a minor in Cognitive science. Passionate about the intersection of human and artificial intelligence. He enjoys running and classic video games. He is currently an intern at LANDR audio.",
    ...
    },
    {
        ...
        bio: 'Veronica is a Masters student, focusing on user-centred AI design and human-AI interaction. She also enjoys reading, window shopping around Montreal, and making easily store-bought foods.',
        linkedin: 'https://www.linkedin.com/in/veronicayx/',
    },
    {
        photo: path('alexandres'),
