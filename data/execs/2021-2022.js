export default [
    ...
    {
        photo: '/images/team/2021-2022/parsa.png',
    ...
    {
        photo: '/images/team/2021-2022/xinrui.png',
        name: 'Xin Rui Li',
    ...
    {
        photo: '/images/team/2021-2022/maggie.png',
        name: 'Maggie Xiong',
    ...
    {
        photo: '/images/team/2021-2022/josh.png',
        name: 'Josh Katofsky',
        position: 'VP Communications',
    ...
    {
        photo: '/images/team/2021-2022/maya.png',
    ...
    {
        photo: '/images/team/2021-2022/zac.png',
        name: 'Zac Bensemana',
        position: 'VP Events',
    ...
    {
        photo: '/images/team/2021-2022/ben.png',
        name: 'Ben Segall',
        position: 'VP Finance',
    ...
    {
        photo: '/images/team/2021-2022/zoe.png',
        name: 'Zoe Wefers',
    ...
    {
        photo: '/images/team/2021-2022/mohamed.png',
    ...
    {
        photo: '/images/team/2021-2022/thomas.png',
    ...
    {
        photo: '/images/team/2021-2022/sheheryar.png',
    ...
    {
        photo: '/images/team/2021-2022/cheng.png',
        name: 'Cheng Chen',
        position: 'Technical Project Manager',
    ...
    {
        photo: '/images/team/2021-2022/simon.png',
        name: 'Simon Berens',
        position: 'Technical Project Manager',
    ...
    {
        photo: '/images/team/2021-2022/kaustav.png',
    ...
    {
        photo: '/images/team/2021-2022/bonnie.png',
        name: 'Bonnie Li',
        position: 'Podcast Producer',
    ...
    {
        photo: '/images/team/2021-2022/cole.png',
        name: 'Cole Killian',
        position: 'Podcast Producer',
    ...
    {
        photo: '/images/team/2021-2022/himanshu.png',
        name: 'Himanshu Ranka',
        position: 'Podcast Producer',
    ...
    {
        photo: '/images/team/2021-2022/mohamedy.png',
    ...
    {
        photo: '/images/team/2021-2022/philip.png',
        name: 'Philip Tam',
        position: 'Senior Advisor',
